      ...
      {!showRecipeInventory && (
        ...
        <div className="min-w-[800px]">
          ...
          <div className="grid grid-cols-8 gap-4">
            ...
            <div className="sticky top-0 left-0 z-20 bg-card shadow-sm font-semibold text-center p-3 text-foreground border-b">
              Meal Type
            </div>
            {orderedDays.map((day, index) => <div key={day} className="sticky top-0 z-10 bg-card shadow-sm text-center p-3 space-y-1 border-b">
            ...
            <div className="contents">
              <div className="sticky left-0 z-10 bg-card shadow-sm p-3 rounded-lg">
            ...
            {allMealTypes.map(mealType => <div key={mealType} className="contents">
                <div className={`sticky left-0 z-10 p-3 rounded-lg flex items-center justify-between shadow-sm bg-${getMealTypeColor(mealType)} text-${getMealTypeColor(mealType)}-foreground`}>
